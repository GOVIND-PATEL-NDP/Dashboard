...
const TableSection = () => {
    ...
    const getStatusColor = (status)=>{
        switch(status){
            case "completed" :
                return "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:emerald-400";
            case "pending":
    ...
    <div className='space-y-6'>
            ...
            <table className='w-full'>
                ...
                <tbody>
                    {recentOrders.map((order,index)=>{
                        return <tr key={index} className='border-b border-slate-200/50 dark:border-slate-700/50 hover:bg-slate-50/50  dark:hover:bg-slate-800/50 transition-colors'>
                        <td className='p-4'>
     ...
     {/* Top product  */}
        <div className='bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-200/50   dark:border-slate-700/50 overflow-hidden'>
         <div className='p-6 border-b  dark:border-slate-700/50 overflow-hidden border-slate-200/50 '>
            <div className='flex items-center justify-between'>
