...
const activities = [
  ...
  },
  {
    ...
    description: 'Order #3847 for $2,390',
    time: '5 minutes ago',
    byColor: 'bg-emerald-100 dark:bg-emerald-900/30',
       ...
       <div className='p-6'>
        <div className='space-x-4'>
            {activities.map((activity)=>{
                return (
                    <div key={activity.id} className='flex items-start gap-x-4 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors'>
