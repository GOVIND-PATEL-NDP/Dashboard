        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center space-x-4'>
            ...
            <div className='hidden md:block'>
              ...
              <p>
                Welcome back, Govind! here's what's happening today 
              </p>
          ...
          <div className='flex max-w-md mx-8'>
            <div className='relative'>
              ...
              <input type='text' placeholder='Search Anything' className='w-full pl-10 pr-4 py-2.5 bg-slate-100 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-xl text-slate-800 dark:text-white placeholder:slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparentd transition-all'/>
              <button className='absolute right-2 top-1/2 transform -translate-y-1/2 p-1.5 text-slate-400 hover:text-slate-500 dark:hover:text-slate-300'>
                <Filter/>
              </button>
            </div>
